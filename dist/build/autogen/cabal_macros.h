...
/* package fp-translator-0.1.0.0 */
#define VERSION_fp_translator "0.1.0.0"
#define MIN_VERSION_fp_translator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "fp-translator-0.1.0.0-IkK3Mn3MvTD6c2juUv1K9S"

#define CURRENT_PACKAGE_KEY "fp-translator-0.1.0.0-IkK3Mn3MvTD6c2juUv1K9S"
